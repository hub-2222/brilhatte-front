    ...
    return( 
        ...
        <>
            <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center *:transition-opacity duration-300">
                <div className={`bg-white flex flex-col justify-between p-4 rounded-md shadow-lg ${full?"md:w-[60%] max-h-[80%] md:h-full h-full":"md:w-auto w-" + widht + " h-auto"}  mx-auto transition-transform duration-300 `}>
